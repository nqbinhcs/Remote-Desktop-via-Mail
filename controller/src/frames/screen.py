...
class Screen(tk.Frame, sender.Sender):
    ...
    def create_widgets(self):
        self.btn_frame.btn_screenshot = tk.Button(self.btn_frame, text="Screenshot", command=self.screenshot)
        self.btn_frame.btn_record = tk.Button(self.btn_frame, text="Record", command=self.record)
        self.btn_frame.btn_screenshot.grid(row=0, column=0, pady=(0, 20))
